...
map.getView().fit([11872881.332202, -695198.998217, 11897600.078211, -679692.184707], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">PETA SEBARAN FASILITAS KESEHATAN DI KOTA JAKARTA BARAT</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (301 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Peta ini merupakan peta sebaran fasilitas kesehatan yang ada di Kota Jakarta Barat yang diambil dari titik koordinat melalui google maps di input ke dalam software pemetaan QGIS.<br /><br />Dibuat Oleh : Maulidya Mafaza<br />Program Studi Kesehatan Masyarakat<br />Fakultas Ilmu Kesehatan<br />UIN Syarif Hidayatullah Jakatrta';
            }
...
var searchLayer = new SearchLayer({
    layer: lyr_FaskesJakartaBarat_2,
    colName: 'Keterangan',
    zoom: 10,
    collapsed: true,
    map: map
